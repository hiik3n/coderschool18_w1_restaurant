...
class FooditemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fooditem" do
    assert_difference('Fooditem.count') do
      post fooditems_url, params: { fooditem: { description: @fooditem.description, name: @fooditem.name, price: @fooditem.price, section: @fooditem.section, url: @fooditem.url } }
    end
  ...
  test "should update fooditem" do
    patch fooditem_url(@fooditem), params: { fooditem: { description: @fooditem.description, name: @fooditem.name, price: @fooditem.price, section: @fooditem.section, url: @fooditem.url } }
