...
class MenuItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create menu_item" do
    assert_difference('MenuItem.count') do
      post menu_items_url, params: { menu_item: { description: @menu_item.description, name: @menu_item.name, price: @menu_item.price, section: @menu_item.section, url: @menu_item.url } }
    end
  ...
  test "should update menu_item" do
    patch menu_item_url(@menu_item), params: { menu_item: { description: @menu_item.description, name: @menu_item.name, price: @menu_item.price, section: @menu_item.section, url: @menu_item.url } }
